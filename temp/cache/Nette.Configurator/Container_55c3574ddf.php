...
class Container_55c3574ddf extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		return new Container_55c3574ddf_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_55c3574ddf_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_55c3574ddf $container)
	{
