<?php
// source: /home/ali/www/ospf/app/config/config.neon 
// source: /home/ali/www/ospf/app/config/config.local.neon 

class Container_262078e452 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\Storage' => [1 => ['storage']],
			...
			'App\Presenters\TrainPresenter' => [1 => ['application.1']],
		...
		'services' => [
			...
			'application.5' => 'App\Presenters\DataPresenter',
			...
			'storage' => 'App\Presenters\Storage',
			'tracy.bar' => 'Tracy\Bar',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/home/ali/www/ospf/app',
			'wwwDir' => '/home/ali/www/ospf/www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/home/ali/www/ospf/app/../temp',
			'dibi' => [
				'driver' => 'mysqli',
				'host' => 'localhost',
				'username' => 'root',
	...
	/**
	 * @return App\Presenters\TrainPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\TrainPresenter($this->getService('storage'));
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('storage'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	/**
	 * @return App\Presenters\DataPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\Presenters\DataPresenter($this->getService('storage'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__presenterFactory()
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/ali/www/ospf/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/ali/www/ospf/app/../temp/cache');
		return $service;
	}
	...
	{
		return new Container_262078e452_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	/**
	 * @return App\Presenters\Storage
	 */
	public function createServiceStorage()
	{
		$service = new App\Presenters\Storage($this);
		return $service;
	}
...
class Container_262078e452_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_262078e452 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('/home/ali/www/ospf/app/../temp/cache/latte');
